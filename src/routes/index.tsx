  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#faf9f7] overflow-x-hidden" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="whatsapp-bounce fixed bottom-24 right-8 z-50 w-14 h-14 rounded-[18px] overflow-hidden flex items-center justify-center shadow-lg hover:shadow-xl transition-transform duration-300 hover:scale-105"
        aria-label="Abrir Instagram @anakfilms_"
      >
        <img
          src={instagramFloatingIconUrl}
          alt="Instagram"
          className="w-full h-full object-cover"
          loading="eager"
        />
